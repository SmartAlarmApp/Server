...
(function ($) {
    ...
    $.fn.gmap3 = function (options) {
        ...
        this.onclickReverseGeocode = function (widget, callback, button) {
            geocode = google.maps.event.addListener(this.map, button, function (me) {
        ...
        this.onclickGetLatLng = function (widget, callback, button) {
            geocode = google.maps.event.addListener(this.map, button, function (me) {
